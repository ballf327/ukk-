...
<head>
  ...
  <title>Tambah Barang Temporary - Admin</title>
...
<body>
  ...
  <div class="main-content">
    ...
    <div class="topbar">
      <h4 class="mb-0">
        <i class="fa fa-plus-circle"></i> Tambah Barang Temporary
      </h4>
    ...
    <div class="form-container">
      <form action="{{ route('admin.temporary-item.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="form-group">
          ...
          <input type="text" id="nama_barang_baru" name="nama_barang_baru" class="form-control" 
                 placeholder="Contoh: Komputer Dell Inspiron" value="{{ old('nama_barang_baru') }}" required>
        ...
        <div class="form-group">
          ...
          <input type="text" id="lokasi_barang_baru" name="lokasi_barang_baru" class="form-control" 
                 placeholder="Contoh: Lab Komputer A" value="{{ old('lokasi_barang_baru') }}" required>
        ...
        <div class="form-group">
          ...
          <select id="status" name="status" class="form-control" required>
            ...
            <option value="baik" @if(old('status') == 'baik') selected @endif>
              <i class="fa fa-check-circle"></i> Baik
            </option>
            <option value="rusak" @if(old('status') == 'rusak') selected @endif>
              <i class="fa fa-times-circle"></i> Rusak
            </option>
            <option value="cacat" @if(old('status') == 'cacat') selected @endif>
              <i class="fa fa-exclamation-circle"></i> Cacat
            </option>
          </select>
          @error('status')
            <small class="text-danger">{{ $message }}</small>
        ...
        <div class="form-group">
          ...
          <textarea id="deskripsi_masalah" name="deskripsi_masalah" class="form-control" 
                    placeholder="Jelaskan masalah atau kerusakan yang ditemukan (opsional)">{{ old('deskripsi_masalah') }}</textarea>
        ...
        <div class="form-group">
          ...
          <input type="text" id="keterangan" name="keterangan" class="form-control" 
                 placeholder="Informasi tambahan (opsional)" value="{{ old('keterangan') }}">
          @error('keterangan')
            <small class="text-danger">{{ $message }}</small>
          @enderror
        </div>
