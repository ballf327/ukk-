...
<input type="text" name="nama_lokasi" class="form-control" id="nama_lokasi" value="{{ $lokasi->nama_lokasi }}" required>
</div>
<button type="submit" class="btn btn-success">Update Ruang</button>
<a href="{{ route('admin.lokasi.crud.index') }}" class="btn btn-secondary">Kembali</a>
</form>
</div>
</body>
</html>
