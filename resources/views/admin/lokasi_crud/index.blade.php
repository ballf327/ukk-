...
<!-- Tombol kembali ke dashboard petugas -->
    <a href="{{ route('dashboard') }}" class="btn btn-secondary mb-3 ms-2">
...
<form action="{{ route('admin.lokasi.crud.destroy', $item->id_lokasi) }}" method="POST" style="display:inline-block;">
@csrf
@method('DELETE')
