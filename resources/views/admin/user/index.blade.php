...
<div class="container mt-5">
    <div class="d-flex justify-content-between mb-4">
        ...
        <div>
            <a href="{{ route('admin.users.create') }}" class="btn btn-primary me-2">+ Tambah Pengguna</a>
        ...
        <tbody>
            @forelse ($users as $index => $u)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('admin.users.edit', $u->id) }}" class="btn btn-sm btn-warning me-1">Edit</a>

                        <form action="{{ route('admin.users.destroy', $u->id) }}" method="POST" style="display:inline" onsubmit="return confirm('Yakin ingin menghapus pengguna ini?');">
                            @csrf
                            @method('DELETE')
