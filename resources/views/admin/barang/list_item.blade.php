...
<div class="container">
    ...
    <a href="{{ route('item.create', $lokasi->id_lokasi) }}" class="btn btn-success my-3">+ Tambah Item</a>
            ...
            @foreach($items as $list)
                @if($list->item)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('item.edit', $list->item->id_item) }}" class="btn btn-warning btn-sm">Edit</a>
